...
const Close = ({ onClick }) => (
  <Icon height='1em' x="0px" y="0px" viewBox="0 0 47.971 47.971" fill='rgb(255,255,255)' onClick={onClick}>
    <g>
...
const More = ({ onClick }) => {
  return (
    <StyledMore viewBox="0 -53 384 384" width='1em' fill='rgb(74,74,74)' onClick={onClick}>
...
const ChatButton = forwardRef((props, ref) => (
  <CTA ref={ref} href='mailto:josh.th.liu@gmail.com' {...props}>LET'S CHAT</CTA>
));

const ChatNavButton = (props) => (
  <CTANav href='mailto:josh.th.liu@gmail.com' {...props} />
);

const GitHubButton = ({ href = 'https://github.com/joshua-t-liu' }) => (
  <CTA href={href}>VIEW CODE</CTA>
);
